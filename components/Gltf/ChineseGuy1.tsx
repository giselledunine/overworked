...
Command: npx gltfjsx@6.5.3 public/chineseGuy1.glb -o components/Gltf/ChineseGuy1.tsx 
*/
...
export function Model(props: JSX.IntrinsicElements["group"]) {
    ...
    const { scene, animations } = useGLTF("/chineseGuy1.glb");
...
useGLTF.preload("/chineseGuy1.glb");
